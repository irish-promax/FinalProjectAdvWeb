<section class="preloader">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="index.html" class="navbar-brand mx-auto mx-lg-0">FYP-MS</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <div class="d-lg-flex align-items-center d-none ms-auto">
                        <a class="custom-btn btn" href="#section_5">
                            ADD LOGIN AND REGISTER HERE LATER
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
                                <br><br><br>
                                <h1 style="color:white">FINAL YEAR PROJECT MANAGEMENT SYSTEM</h1>
                            </div>
                        </div>
                    </div>
                </div>
